        ...
        <svg :viewBox="`0 0 ${CHART_W} ${CHART_H}`" class="w-full" preserveAspectRatio="none" style="height:140px">
          <defs>
            <linearGradient id="rptGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%"   stop-color="#008080" stop-opacity="0.3" />
          ...
          <!-- Line -->
          <polyline :points="polyline" fill="none" stroke="#008080" stroke-width="2.5"
            stroke-linejoin="round" stroke-linecap="round" />
          <!-- Dots on data points -->
          <circle v-for="pt in chartPts" :key="pt.label"
            :cx="pt.x" :cy="pt.y" r="3.5" fill="#008080" stroke="white" stroke-width="1.5" />
        </svg>
    ...
    <UCard>
      ...
      <div class="mb-5">
        ...
        <div class="h-2.5 rounded-full overflow-hidden flex">
          <div
            class="bg-teal-500 transition-all duration-700"
