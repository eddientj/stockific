  ...
  <div class="space-y-5 text-sm">
    ...
    <div class="flex items-start justify-between gap-4">
        ...
        <template v-else>
          <div class="flex items-center gap-2 mb-1">
            <span
              ...
              :style="{ background: settings?.accent_color ?? '#008080' }"
            />
      ...
      <div class="text-right">
        ...
        <p class="text-xs font-mono mt-0.5" :style="{ color: settings?.accent_color ?? '#008080' }">
    ...
    <div class="space-y-1 ml-auto w-52">
      ...
      <div v-if="discount > 0" class="flex justify-between text-xs">
        ...
        <span :style="{ color: settings?.accent_color ?? '#008080' }">-{{ rm(discount) }}</span>
      </div>
      <div class="flex justify-between font-bold border-t border-(--ui-border) pt-1.5 mt-1.5">
        ...
        <span :style="{ color: settings?.accent_color ?? '#008080' }">{{ rm(total) }}</span>
      </div>
    </div>
